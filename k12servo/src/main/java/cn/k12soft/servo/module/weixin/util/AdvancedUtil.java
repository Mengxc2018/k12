package cn.k12soft.servo.module.weixin.util;
...
import cn.k12soft.servo.module.weixin.message.resp.Article;
import cn.k12soft.servo.module.weixin.message.resp.Music;
import cn.k12soft.servo.module.weixin.pojo.SNSUserInfo;
import cn.k12soft.servo.module.weixin.pojo.WeixinGroup;
import cn.k12soft.servo.module.weixin.pojo.WeixinMedia;
import cn.k12soft.servo.module.weixin.pojo.WeixinOauth2Token;
import cn.k12soft.servo.module.weixin.pojo.WeixinQRCode;
import cn.k12soft.servo.module.weixin.pojo.WeixinUserInfo;
import cn.k12soft.servo.module.weixin.pojo.WeixinUserList;
...
public class AdvancedUtil {
	...
	public static WeixinMedia uploadMedia(String accessToken, String type, String mediaFileUrl) {
		...
		try {
			...
			// 设置请求头Content-Type
			uploadConn.setRequestProperty("Content-Type", "multipart/domain-data;boundary=" + boundary);
			...
			outputStream.write(String.format("Content-Disposition: domain-data; name=\"media\"; filename=\"file1%s\"\r\n", fileExt).getBytes());
	...
	public static void main(String args[]) {
		...
		article1.setUrl("http://repository.duopao.com/duopao/games/small_games/weixingame/Doudizhu/doudizhu.htm");
		Article article2 = new Article();
		article2.setTitle("傲气雄鹰\n80后不得不玩的经典游戏");
		article2.setDescription("");
		article2.setPicUrl("http://www.egouji.com/xiaoq/game/aoqixiongying.png");
		article2.setUrl("http://repository.duopao.com/duopao/games/small_games/weixingame/Plane/aoqixiongying.html");
