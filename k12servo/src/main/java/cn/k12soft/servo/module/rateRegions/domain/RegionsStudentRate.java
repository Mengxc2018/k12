...
@Entity
@DynamicUpdate
public class RegionsStudentRate {
    @Id
    @GeneratedValue
    private Long id;
    @OneToOne
    ...
    public RegionsStudentRate(){}

    public RegionsStudentRate(Regions regions, Integer groupId, String january, String february, String march, String april, String may, String june, String july, String auguest, String september, String october, String november, String december, Instant createdAt) {
