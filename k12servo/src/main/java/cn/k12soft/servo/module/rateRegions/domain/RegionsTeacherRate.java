package cn.k12soft.servo.module.rateRegions.domain;
...
@Entity
@DynamicUpdate
public class RegionsTeacherRate {
    @Id
    @GeneratedValue
    private Long id;
    @OneToOne
    ...
    public RegionsTeacherRate(){}

    public RegionsTeacherRate(Regions regions, Integer groupId, String january, String february, String march, String april, String may, String june, String july, String auguest, String september, String october, String november, String december, Instant createdAt) {
