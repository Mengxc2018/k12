...
@Entity
@DynamicUpdate
public class StudentSchoolRate{
    @Id
    @GeneratedValue
    private Long id;
    @ManyToOne
    ...
    public StudentSchoolRate(){}

    public StudentSchoolRate(School school, int cityId, Instant createdAt) {
        this.school = school;
        this.cityId = cityId;
        this.createdAt = createdAt;
    }

    public StudentSchoolRate(School school, Integer cityId, String january, String february, String march, String april, String may, String june, String july, String auguest, String september, String october, String november, String december, Instant createdAt) {
        this.school = school;
        this.cityId = cityId;
