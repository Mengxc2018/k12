...
@Entity
@DynamicUpdate
public class ProvinceStudentsRate {
    @Id
    @GeneratedValue
    private Long id;
    @OneToOne
    ...
    public ProvinceStudentsRate(){}

    public ProvinceStudentsRate(Provinces provinces, Integer regionId, String january, String february, String march, String april, String may, String june, String july, String auguest, String september, String october, String november, String december, Instant createdAt) {
